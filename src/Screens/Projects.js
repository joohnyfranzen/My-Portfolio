...
export default function Projects() {
    ...
    const paragraphs=[
        ...
        {id:12,value:"ThothCode-React was a project of great value and development for me, I was based on many tutorials on the internet and help from several Youtube videos to carry out the front-end of this application, since it would be Fullstack I should integrate with the use of Axios tool to be able to make the integration, I had a huge difficulty in several moments, but luckily I managed to finish it to give me the this achievement."},
        {id:13,value:"And finally this portfolio you are reading, it was made using React, and at first sight it has been easy to develop, since it is a static site, I am resuming my initial studies about the standard html css and use of some tools and adding icons... Thanks for reading this far, may the force be with you. bye."}, 
    ];
                ...
                <div className="items">
                    <div className="item-container">
                        <div className="item-container-2">
                            ...
                            <a className="linkTo" rel="noopener noreferrer" target="_blank" href="https://joohnyfranzen.github.io/Calculator-JS/"><BiNavigation/></a>
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Calculator-JS"><BiCodeAlt/></a>
                        </div>
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(1)}>MataMosca-JS</p> 
                            <a className="linkTo" rel="noopener noreferrer" target="_blank" href="https://joohnyfranzen.github.io/Js-Game-MataMosca/"><BiNavigation/></a>
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Js-Game-MataMosca"><BiCodeAlt/></a>
                        </div>                        
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(2)}>Mario-JS</p> 
                            <a className="linkTo" rel="noopener noreferrer" target="_blank" href="https://joohnyfranzen.github.io/Mario-Game/"><BiNavigation/></a>
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Mario-Game"><BiCodeAlt/></a>
                        </div>
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(3)}>Thoughts-Node</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Thougths"><BiCodeAlt/></a>
                        </div>
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(4)}>Challenge-Node</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Desafio-Multiplier-Integracao-Node"><BiCodeAlt/></a>
                        </div>
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(5)}>RestApi-Nest</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Nest-Rest-api"><BiCodeAlt/></a>
                        </div>
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(6)}>LeidyApp-Nest</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Leidy-Nest-App"><BiCodeAlt/></a>
                        </div>
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(7)}>LeidyApp-Nest-Docker</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/App-Nest_Docker"><BiCodeAlt/></a>
                        </div>     
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(8)}>LeidyApp-Nest-Docker-Sqlite</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Leidy_App-Nest_Sqlite_Docker_v1"><BiCodeAlt/></a>
                        </div>    
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(9)}>My_Property-Laravel</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/My_Property-Laravel_Project"><BiCodeAlt/></a>
                        </div> 
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(10)}>Laravel-GraphQL</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/GraphQl_Laravel_Example"><BiCodeAlt/></a>
                        </div>  
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(11)}>ThothCode-Laravel</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Thoth-Code-Laravel"><BiCodeAlt/></a>
                        </div>   
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(12)}>ThothCode-React</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/Thoth-Code-React"><BiCodeAlt/></a>
                        </div>  
                        <div className="item-container-2">
                            <p onClick={()=>handleClick(13)}>ThisPortfolio-React</p> 
                            <a className="git" rel="noopener noreferrer" target="_blank" href="https://github.com/joohnyfranzen/portfolio"><BiCodeAlt/></a>
                        </div>                    
                    </div>
               </div>
